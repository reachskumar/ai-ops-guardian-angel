...
class ArtifactManagementAgent(BaseAgent):
    ...
    def __init__(self):
        capabilities = AgentCapabilities(
            supported_tasks=["store_artifact", "version_artifact", "distribute_artifact", "scan_artifact", "optimize_artifact"],
            required_tools=["artifact_manager", "version_control", "distribution"],
            max_concurrent_tasks=5,
            average_response_time=20.0
        )
        
        super().__init__(
            agent_type=AgentType.ARTIFACT_MANAGEMENT,
