...
class KubernetesAgent(BaseAgent):
    ...
    def __init__(self):
        capabilities = AgentCapabilities(
            supported_tasks=["deploy_application", "scale_deployment", "optimize_cluster", "configure_service_mesh", "monitor_cluster"],
            required_tools=["kubernetes_manager", "cluster_optimizer", "service_mesh"],
