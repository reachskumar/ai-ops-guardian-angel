...
class ModelMonitoringAgent(BaseAgent):
    ...
    def __init__(self):
        capabilities = AgentCapabilities(
            supported_tasks=["model_monitoring", "drift_detection", "performance_analysis", "model_alerting", "model_retraining"],
            required_tools=["model_monitor", "drift_detector", "performance_analyzer"],
            max_concurrent_tasks=5,
            average_response_time=25.0
        )
        
        super().__init__(
            agent_type=AgentType.MODEL_MONITORING,
