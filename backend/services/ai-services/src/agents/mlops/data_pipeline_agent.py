...
class DataPipelineAgent(BaseAgent):
    ...
    def __init__(self):
        capabilities = AgentCapabilities(
            supported_tasks=["data_processing", "etl_automation", "data_validation", "data_transformation", "pipeline_orchestration"],
            required_tools=["data_processor", "pipeline_orchestrator", "data_validator"],
