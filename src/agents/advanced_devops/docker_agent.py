...
class DockerAgent(BaseAgent):
    ...
    def __init__(self):
        super().__init__(
            ...
            capabilities=[
                AgentCapabilities.CONTAINER_ORCHESTRATION,
                AgentCapabilities.CONTAINER_OPTIMIZATION,
                AgentCapabilities.CONTAINER_SECURITY,
                AgentCapabilities.CONTAINER_MONITORING,
                AgentCapabilities.CONTAINER_DEPLOYMENT
            ]
        )
