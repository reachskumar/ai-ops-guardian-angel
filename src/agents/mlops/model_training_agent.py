...
class ModelTrainingAgent(BaseAgent):
    ...
    def __init__(self):
        super().__init__(
            ...
            capabilities=[
                AgentCapabilities.ML_TRAINING,
                AgentCapabilities.MODEL_DEPLOYMENT,
                AgentCapabilities.HYPERPARAMETER_TUNING,
                AgentCapabilities.FEATURE_ENGINEERING,
                AgentCapabilities.MODEL_VERSIONING
            ]
        )
